...
# ─────────────────────────────────────────────
print("="*50) 
print("CATBOOST.PY — CatBoost Shortlisting")
print("="*50)
...
# CatBoost native categorical handling — cast objects to str, collect indices
cat_features_idx = []
...
cat_feature_names = [X.columns[i] for i in cat_features_idx]
...
print(f"\n✅ Model trained — best iteration: {model.get_best_iteration()} / {model.tree_count_} trees")
...
feat_imp = feat_imp / feat_imp.sum()  # normalize to match RF style
